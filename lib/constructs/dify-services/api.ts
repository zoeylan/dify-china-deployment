  ...
  volumes: [
    ...
    taskDefinition.addContainer('Main', {
      image: customRepository
        ...
        : ecs.ContainerImage.fromRegistry(`123456789000.dkr.ecr.cn-north-1.amazonaws.com.cn/dify-api:${props.imageTag}`),
    ...
    const sandboxContainer = taskDefinition.addContainer('Sandbox', {
      image: customRepository
        ...
        : ecs.ContainerImage.fromRegistry(`123456789000.dkr.ecr.cn-north-1.amazonaws.com.cn/dify-sandbox:${props.sandboxImageTag}`),
      environment: {
        GIN_MODE: 'release',
        WORKER_TIMEOUT: '15',
        ENABLE_NETWORK: 'true',
    ...
    taskDefinition.addContainer('PluginDaemon', {
      image: customRepository
        ...
        : ecs.ContainerImage.fromRegistry(`123456789000.dkr.ecr.cn-north-1.amazonaws.com.cn/dify-plugin-daemon:${props.pluginDaemonImageTag}`),
      environment: {
        GIN_MODE: 'release',
        ...
        S3_USE_AWS_MANAGED_IAM: 'true',
        S3_ENDPOINT: `https://s3.${Stack.of(this).region}.amazonaws.com.cn`,
      },
      secrets: {
        DB_USERNAME: ecs.Secret.fromSecretsManager(postgres.secret, 'username'),
        DB_HOST: ecs.Secret.fromSecretsManager(postgres.secret, 'host'),
